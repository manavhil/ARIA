// components/ui/circular-testimonials.tsx
"use client";
...
export const CircularTestimonials = ({
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-4 md:p-8" dir={dir}>
      <div className="grid gap-12 md:gap-20 md:grid-cols-2 items-center">
        {/* Images */}
        <div className="relative w-full h-[280px] md:h-[400px] [perspective:1000px]" ref={imageContainerRef}>
        ...
        <div className="flex flex-col justify-between h-full py-4">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="mb-6 font-mono tracking-wide" style={{ color: colorDesignation, fontSize: fontSizeDesignation }}>
          ...
          <div className={`flex gap-6 pt-10 md:pt-16 ${dir === "rtl" ? "flex-row-reverse justify-end" : ""}`}>
            <button
